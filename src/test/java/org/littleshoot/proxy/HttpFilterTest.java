...
public class HttpFilterTest
{
    ...
    public void testFiltering () throws Exception
    {
        ...
        Thread.sleep (500);
        assertEquals ("Response should have included the custom header from our pre filter", "1", response1.getFirstHeader ("Header-Pre").getValue ());
        assertEquals ("Response should have included the custom header from our post filter", "2", response1.getFirstHeader ("Header-Post").getValue ());
    ...
    public void testResolutionFailedCalledAfterDnsFailure () throws Exception
    {
        ...
        this.proxyServer = DefaultHttpProxyServer.bootstrap ().withPort (0).withFiltersSource (filtersSource).withServerResolver (mockFailingResolver).start ();
    ...
    public void testFiltersAfterUnencryptedConnectionToUpstreamProxyFails () throws Exception
    {
        ...
        this.proxyServer = DefaultHttpProxyServer.bootstrap ().withPort (0).withFiltersSource (filtersSource).withChainProxyManager (new ChainedProxyManager ()
        {
            @Override
    ...
    public void testFiltersAfterSSLConnectionToUpstreamProxyFails () throws Exception
    {
        ...
        final HttpProxyServer chainedProxy = DefaultHttpProxyServer.bootstrap ().withName ("ChainedProxy").withPort (0).withSslEngineSource (new SelfSignedSslEngineSource ("chain_proxy_keystore_1.jks")).start ();
    ...
    {
        mockServer.when (request ().withMethod ("GET").withPath ("/servertimeout"), Times.once ()).respond (response ().withStatusCode (200).withDelay (TimeUnit.SECONDS, 10).withBody ("success"));
    ...
    {
        mockServer.when (request ().withMethod ("GET").withPath ("/testNullHttpFilterSource"), Times.exactly (1)).respond (response ().withStatusCode (200).withBody ("success"));
