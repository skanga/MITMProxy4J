...
public class TimeoutTest
{
    ...
    public void testIdleConnectionTimeout () throws IOException
    {
        ...
        mockServer.when (request ().withMethod ("GET").withPath ("/idleconnection"), Times.exactly (1)).respond (response ().withStatusCode (200).withDelay (new Delay (TimeUnit.SECONDS, 5)));
        ...
        assertThat ("Expected idle connection timeout to happen after approximately 1 second", TimeUnit.MILLISECONDS.convert (stop - start, TimeUnit.NANOSECONDS), lessThan (2000L));
    }
    ...
    public void testConnectionTimeout () throws IOException
    {
        ...
        assertThat ("Expected connection timeout to happen after approximately 1 second", TimeUnit.MILLISECONDS.convert (stop - start, TimeUnit.NANOSECONDS), lessThan (2000L));
    }
