...
public class MessageTerminationTest
{
    ...
    public void testResponseWithoutTerminationIsChunked () throws Exception
    {
        ...
        mockServer.when (request ().withMethod ("GET").withPath ("/"), Times.unlimited ()).respond (response ().withStatusCode (200).withBody ("Success!").withConnectionOptions (new ConnectionOptions ().withCloseSocket (true).withSuppressConnectionHeader (true).withSuppressContentLengthHeader (true)));
    ...
    public void testResponseWithContentLengthNotModified () throws Exception
    {
        ...
        mockServer.when (request ().withMethod ("GET").withPath ("/"), Times.unlimited ()).respond (response ().withStatusCode (200).withBody ("Success!").withConnectionOptions (new ConnectionOptions ().withCloseSocket (true).withSuppressConnectionHeader (true)));
    ...
    public void testFilterAddsContentLength () throws Exception
    {
        ...
        proxyServer = DefaultHttpProxyServer.bootstrap ().withFiltersSource (new HttpFiltersSourceAdapter ()
        {
            @Override
    ...
    public void testResponseToHEADNotModified () throws Exception
    {
        ...
        mockServer.when (request ().withMethod ("HEAD").withPath ("/"), Times.unlimited ()).respond (response ().withStatusCode (200).withConnectionOptions (new ConnectionOptions ().withCloseSocket (false).withSuppressConnectionHeader (true).withSuppressContentLengthHeader (true)));
