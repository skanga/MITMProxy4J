...
public class ThrottlingTest
{
    ...
    public void setUp () throws Exception
    {
        ...
        byte fillByte = (byte) 1 % 256;
        Arrays.fill (largeData, fillByte);
    ...
    public void aWarmUpTest () throws IOException
    {
        ...
        HttpProxyServer proxyServer = DefaultHttpProxyServer.bootstrap ().withPort (0).withThrottling (0, THROTTLED_WRITE_BYTES_PER_SECOND).start ();
    ...
    public void testThrottledWrite () throws Exception
    {
        ...
        assertThat ("Expected throttled write to complete in approximately " + msToWriteThrottled + "ms" + " but took " + (finish - start) + "ms", (double) (finish - start), both (greaterThan (msToWriteThrottled * (1 - ALLOWABLE_VARIATION))).and (lessThan (msToWriteThrottled * (1 + ALLOWABLE_VARIATION))));
    ...
    public void testUnthrottledWrite () throws Exception
    {
        ...
        assertThat ("Unthrottled write took " + (finish - start) + "ms, but expected to complete in " + UNTRHOTTLED_REQUEST_TIME_MS + "ms", finish - start, lessThan ((long) UNTRHOTTLED_REQUEST_TIME_MS));
    ...
    public void testThrottledRead () throws Exception
    {
        ...
        assertThat ("Expected throttled read to complete in approximately " + msToReadThrottled + "ms" + " but took " + (finish - start) + "ms", (double) (finish - start), both (greaterThan (msToReadThrottled * (1 - ALLOWABLE_VARIATION))).and (lessThan (msToReadThrottled * (1 + ALLOWABLE_VARIATION))));
    ...
    public void testUnthrottledRead () throws Exception
    {
        ...
        assertThat ("Unthrottled read took " + (finish - start) + "ms, but expected to complete in " + UNTRHOTTLED_REQUEST_TIME_MS + "ms", finish - start, lessThan ((long) UNTRHOTTLED_REQUEST_TIME_MS));
    ...
    public void testDisableThrottling () throws IOException
    {
        ...
        assertThat ("Expected second read to complete within " + UNTRHOTTLED_REQUEST_TIME_MS + "ms, without throttling. First read took " + (firstFinish - firstStart) + "ms" + ". Second read took " + (secondFinish - secondStart) + "ms", secondFinish - secondStart, lessThan ((long) UNTRHOTTLED_REQUEST_TIME_MS));
